          ...
          >
            ...
            {activeIndex === key && (
              <div className="fixed z-[10] top-0 left-0 w-screen min-w-screen h-dvh min-h-dvh bg-white px-4 pt-10 overflow-y-scroll big-tablet:overflow-y-none  pb-16 overscroll-none ">
                <div className="hidden big-tablet:fixed big-tablet:top-[0] big-tablet:w-auto big-tablet:right-[18vw]  big-tablet:pt-[5vh] big-tablet:flex big-tablet:flex-col big-tablet:gap-4 big-tablet:z-[-1] big-tablet:pr-8">
                ...
                {project.productionInfo && (
                  <div className="max-w-md mt-32 text-sm big-tablet:fixed big-tablet:bottom-4 big-tablet:right-4 big-tablet:text-right big-tablet:mt-0 big-tablet:pr-4">
